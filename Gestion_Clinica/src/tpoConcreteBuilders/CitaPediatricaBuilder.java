...
public class CitaPediatricaBuilder implements ICitaBuilder{
	...
	public void buildHorario(LocalDateTime hora) {
		cita.setHorario(hora, EspecMedica.PEDIATRIA);
		// La duración específica para pediatría ya se maneja dentro de la clase Cita
		
	}
	
	@Override
	public void buildEspecMedica() {
		cita.setEspecMedica(EspecMedica.PEDIATRIA);
