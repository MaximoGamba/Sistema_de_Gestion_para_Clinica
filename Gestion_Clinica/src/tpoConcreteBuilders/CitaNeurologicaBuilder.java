...
//NEUROLOGIA DURA 45 MIN
//PEDIATRIA DURA 30
//CARDIOLOGIA DURA 35
//TRAUMATOLOGIA 30

public class CitaNeurologicaBuilder implements ICitaBuilder{
	...
	public void buildHorario(LocalDateTime hora) {
		cita.setHorario(hora, EspecMedica.NEUROLOGIA);
		// La duración específica para neurología ya se maneja dentro de la clase Cita
	...
	public void buildEspecMedica() {
		cita.setEspecMedica(EspecMedica.NEUROLOGIA);
